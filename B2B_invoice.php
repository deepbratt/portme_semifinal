...
<head>
	...
	<title>B2B Invoice | Port-ME </title>
								...
								<table class="table table-b-t table-b-b datatable-default rs-table table-default" style="border-right:1px solid #f5f5f5;border-left:1px solid #f5f5f5;">
							        ...
							        <tbody>
							            <tr>
							                ...
							                <td> <input type="text" style="width:120px;margin:5px;"> </td>
											<td> <input type="text" style="width:120px;margin:5px;"> </td>
											<td> <input type="text" class="form-control rs-datepicker" placeholder="Invoice Date" name="" style="width:120px;margin:5px;"> </td>
							                <td> <input type="text" style="width:120px;margin:5px;"> </td>
											...
											<select name="" class="form-control" style="width:120px;margin:5px;">									
														...
														<option value="">SEZ Supplies with payment</option>
														<option value="">SEZ Supplies without payment</option>
											</select>
											
											</td>
											<td><input type="checkbox" name="" value="" selected disabled style="width:20px;height:30px;margin:5px;"></td>
											<td> <input type="text" style="width:120px;margin:5px;" selected disabled> </td>
