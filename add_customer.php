...
if(isset($_POST['submit_details']))
{
	...
	$old_customer_details = mysqli_query($mysqli,"select * from tbl_contacts");
	$fetch_customer_details = mysqli_fetch_array($old_customer_details);

	if($fetch_customer_details['email'] != $email and $fetch_customer_details['mobile'] != $mobile and  $fetch_customer_details['work_phone'] != $work_phone)
	{
