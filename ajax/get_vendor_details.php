<?php
	...
	$get_cust_query = mysqli_query($mysqli,"SELECT * FROM tbl_contacts WHERE customer_id='$value' and customer_type='vendor'");
	$fetch_cust_query = mysqli_fetch_array($get_cust_query);
	
?>

<div class="col-sm-12">
	<label style="font-size:20px;border-bottom:1px solid #CCC;">
		CUSTOMER DETAILS
	</label>
</div>
<div class="col-sm-12">
...
<div class="col-sm-12">
	<label style="font-size:15px;" class="enterprise">
		<?php echo ucfirst($fetch_cust_query['enterprise_name']);?>
	</label>
</div>
