...
$select_data = mysqli_query($mysqli,"select * from tbl_productcat where productcat_id='$cat_id'");
...
$update_query = mysqli_query($mysqli,"update tbl_productcat set attr_name='$new_attr_name',attr_value='$new_attr_value' where productcat_id='$cat_id'");
if($update_query){
	$select_query = mysqli_query($mysqli,"select * from tbl_productcat where productcat_id='$cat_id'");
