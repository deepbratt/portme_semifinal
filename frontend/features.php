            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1>
						<a href="" class="typewrite" data-period="2000" data-type='[ "Features.", "I Love to give You all the Features.", "Explore the Features and Attractions." ]'>
...
<li>Effortless and efficient.</li>
  ...
  <section class="ptb-100 functionalities bg-gray" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <img src="images/product_list.png" class="img-responsive" alt="image">
        </div>
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="main-title">
