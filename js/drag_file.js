...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'dropzone',
        defaults = {
            ...
            text:                   '<i class="fa fa-cloud" style="font-size:50px;color:#0099ff;margin-top:25%;"></i><p>Drag images here to upload</p>',    //text inside the div
