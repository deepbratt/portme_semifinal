...
if(isset($_GET['delete_id']))
{
	...
	if($delete_customer)
		{
			echo "<script>window.location.href='purchase_order_info.php'</script>";
		}
}
$sale_order_info = mysqli_query ($mysqli,"select * from tbl_transactions where business_id='".$business_id."' and tbl_transaction_type='purchase' and status='active'");
...
<head>
	...
	<title>My Purchase Order | Port-ME </title>
							        ...
							        <tbody>
										...
										<td><?php echo $fetch_sales_order_info['invoice_no']?></td>
							                ...
							                <td><?php echo $fetch_sales_order_info['date']?></td>
							               	<td>
												<a href="print_invoice.php?order_id=<?php echo $fetch_sales_order_info['tbl_transaction_id'];?>" class="btn btn-default" style="margin:3px;"> View </a>												
