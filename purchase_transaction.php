...
$bill_info = mysqli_query($mysqli, "select * from tbl_transactions where business_id='".$business_id."' and tbl_transaction_type='purchase' and status = 'active'");
?>
...
<title>Port-ME | Purchase Transaction </title>
