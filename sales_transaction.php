								...
								<tr>
							        ...
							        <tbody>
										...
										<td><?php echo $fetch_sales_order_info['invoice_no']?></td>
							                ...
							                <td>
											<?php 
											$product_info = $fetch_sales_order_info['product_id_array'];
											$get_pro_details = mysqli_query($mysqli, "select * from tbl_products where product_id = '$product_info'");
											$fetch_product = mysqli_fetch_array($get_pro_details);
											echo ucfirst($fetch_product['name']);
											?>
											</td>
											...
											<td>
											<a href="print_invoice.php?order_id=<?php echo $fetch_sales_order_info['tbl_transaction_id'];?>" class="fa fa-eye" style="height:35px;margin-top:10px;padding-right:-50px; font-size:25px"> </a>	
											<a href="?delete_id=<?php echo $fetch_sales_order_info['tbl_transaction_id'];?>" class="fa fa-trash" style="height:35px;margin-top:10px;padding-right:-50px; font-size:25px"></a></td>
							            </tr>
										 <?php
										}
										?>	
