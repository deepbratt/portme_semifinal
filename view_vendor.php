...
$view_customer_info = mysqli_query($mysqli,"select * from tbl_contacts where customer_id='".$vendor_id."' and customer_type ='vendor'");
								...
								<div class="panel panel-plain panel-rounded">
									...
									<div class="panel-footer">
											<div class="form-group m-a-0">
												<a class="btn btn-success btn-wide" href="edit_vendor.php?vendor_id=<?php echo $fetch_customer_details['customer_id'];?>" style="color:white;">Edit</a>
												<a class="btn btn-success btn-wide" href="vendor.php" style="color:white;">Back</a>
											</div>
										</div><!-- /.panel-footer -->
									</form>
								</div><!-- /.panel -->
